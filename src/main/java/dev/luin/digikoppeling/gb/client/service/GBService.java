...
@WebService(name = "GBService", targetNamespace="http://luin.dev/digikoppeling/gb/client/1.0", serviceName = "GBService", endpointInterface = "GBServiceSoapBinding", portName = "GBServicePort")
